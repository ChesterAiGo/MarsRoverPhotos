...
import com.marsrover.repository.PreferencesRepository;
import com.marsrover.response.MarsPhoto;
import com.marsrover.response.MarsRoverApiResponse;

@Service
public class MarsRoverApiService {

  private static final String API_KEY = "zcPjNPYEh4DUY60APqYRQ8LDSCfaQXmPX4Fe1rnn";
